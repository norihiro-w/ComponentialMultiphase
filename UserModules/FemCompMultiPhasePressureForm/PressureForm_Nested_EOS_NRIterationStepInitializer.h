...
#ifndef PRESSUREFORM_NESTED_EOS_NR_ITERATION_STEP_INITIALIZER_H
#define PRESSUREFORM_NESTED_EOS_NR_ITERATION_STEP_INITIALIZER_H

#include "NonLinearCMP_PressureForm_TimeODELocalAssembler.h"
#include "NonLinearCMP_PressureForm_JacobianLocalAssembler.h"
#include "NumLib/TransientAssembler/ElementWiseTimeEulerResidualLocalAssembler.h"

template <class T_NODAL_FUNCTION_SCALAR, class T_FUNCTION_DATA>
class PressureForm_Nested_EOS_NRIterationStepInitializer
{
public:
	PressureForm_Nested_EOS_NRIterationStepInitializer(
		NonLinearCMP_PressureForm_TimeODELocalAssembler<NumLib::ElementWiseTimeEulerResidualLocalAssembler, T_NODAL_FUNCTION_SCALAR, T_FUNCTION_DATA>* assemblerR,
		NonLinearCMP_PressureForm_JacobianLocalAssembler<T_NODAL_FUNCTION_SCALAR, T_FUNCTION_DATA> *assemblerJ)
...
private:
	...
	*/
	NonLinearCMP_PressureForm_TimeODELocalAssembler<NumLib::ElementWiseTimeEulerResidualLocalAssembler, T_NODAL_FUNCTION_SCALAR, T_FUNCTION_DATA>* _assemblerR;

	/**
	* pointer to assemblerJ
	*/
	NonLinearCMP_PressureForm_JacobianLocalAssembler<T_NODAL_FUNCTION_SCALAR, T_FUNCTION_DATA>* _assemblerJ;
