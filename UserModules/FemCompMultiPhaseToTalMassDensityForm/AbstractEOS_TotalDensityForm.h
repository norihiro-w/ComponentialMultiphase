...
#ifndef ABSTRACTEOS_TOTALDENSITYFORM_H 
#define ABSTRACTEOS_TOTALDENSITYFORM_H 

#include "ChemLib/chemconst.h"

class AbstractEOS_TotalDensityForm {
public:
	/**
	  * constructor, input is the number of unknowns
	  */
	AbstractEOS_TotalDensityForm(std::size_t n_unknowns)
		:N(n_unknowns)
	{};
	...
	/**
	  ...
	  */
	virtual ~AbstractEOS_TotalDensityForm() {};
