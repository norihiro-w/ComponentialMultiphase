...
*
*
* \file SingleStepCompMultiPhase.h
*
* Created on 2013-05-12 by Yonghui HUANG
*/

#ifndef SINGLE_STEP_COMP_MULTI_PHASE_H 
#define SINGLE_STEP_COMP_MULTI_PHASE_H 
...
>
class SingleStepCompMultiPhase
...
public:
	...
	*/
	SingleStepCompMultiPhase(MyDiscreteSystem*      dis,
	...
	*/
	virtual ~SingleStepCompMultiPhase()
	{
		/*
...
private:
	DISALLOW_COPY_AND_ASSIGN(SingleStepCompMultiPhase);
...
template <
	...
	class T_USER_NON_LINEAR_SOLUTION
>
SingleStepCompMultiPhase<T_USER_FUNCTION_DATA, T_USER_FEM_PROBLEM, T_USER_NON_LINEAR_PROBLEM, T_USER_NON_LINEAR_SOLUTION>
::SingleStepCompMultiPhase(MyDiscreteSystem*                dis,
                           UserFemProblem*                  problem,
						   UserNonLinearSolution*           nlin_solution,
						   UserFunctionData*                function_data)
...
_problem(problem), _nlin_solution(nlin_solution), _discrete_system(dis), _function_data(function_data)
{
	...
	INFO("->Setting up a solution algorithm for CMP_2P2C problem.");
...
template <class T_USER_FUNCTION_DATA,
		  ...
		  class T_USER_NON_LINEAR_PROBLEM,
		  class T_USER_NON_LINEAR_SOLUTION>
int SingleStepCompMultiPhase<T_USER_FUNCTION_DATA, T_USER_FEM_PROBLEM, T_USER_NON_LINEAR_PROBLEM, T_USER_NON_LINEAR_SOLUTION>
::solveTimeStep(const NumLib::TimeStep &t_n1)
{
	// print solving information
	INFO("--Solving nonlinear equation for the CMP_2P2C process. \n");
