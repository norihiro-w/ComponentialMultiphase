...
#ifndef LOCAL_PROBLEM_EOS_H
#define LOCAL_PROBLEM_EOS_H
...
public:
	...
	/**
	  ...
	  */
	const double tot = 1.0e-14; //a small tolorence is necessary for the iteration
...
private:
	...
	/**
	  * molar_fraction ---primary variable
	  */
	double X_L;
