...
*
*
* \file Fem_CMP_2P2C_Solution.h
*
* Created on 2014-05-15 by Yonghui HUANG
*/

#ifndef FEM_CMP_2P2C_SOLUTION_H
#define FEM_CMP_2P2C_SOLUTION_H
...
namespace SolutionLib
{
	...
	*/
	...
	class Fem_CMP_2P2C_Solution : public TimeSteppingProblem
	{
	public:
		...
		/**
		  * constructor
		  */
		explicit Fem_CMP_2P2C_Solution(MyDiscreteSystem* dis)
	...
	private:
		DISALLOW_COPY_AND_ASSIGN(Fem_CMP_2P2C_Solution);
