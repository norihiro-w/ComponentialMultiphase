...
#include "math.h"
#include <algorithm>
#include "AbstractEOS_CapPresFormular.h"
#include <cmath>
 ...
 */
class EOS_CapPresFormular : public AbstractEOS_CapPresFormular
{
public:
	...
	/**
	  * Constructor
	  */
	EOS_CapPresFormular() : AbstractEOS_CapPresFormular(1)
    {
    };
...
private:
	...
	const double Hen = 1e-3; //Henry constant

	const double C_h = 1.414e-4;// Here I define a constant value C_h which is equal to Hen*M_G(Molar mass of gas)
