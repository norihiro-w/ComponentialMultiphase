...
*
*
* \file Fem_CMP_CapPresFormular_Solution.h
*
* Created on 2015-03-15 by Yonghui HUANG
*/

#ifndef FEM_CMP_CAPPRESFORMULAR_SOLUTION_H
#define FEM_CMP_CAPPRESFORMULAR_SOLUTION_H
...
namespace SolutionLib
{
	...
	*/
	...
	class Fem_CMP_CapPresFormular_Solution : public TimeSteppingProblem
	{
	public:
		...
		/**
		  * constructor
		  */
		explicit Fem_CMP_CapPresFormular_Solution(MyDiscreteSystem* dis)
		...
		/**
		  * destructor
		  */
		virtual ~Fem_CMP_CapPresFormular_Solution()
		{
	...
	private:
		DISALLOW_COPY_AND_ASSIGN(Fem_CMP_CapPresFormular_Solution);
