 ...
 * \file AbstractEOS.h
 *
 * Created on 2015-03-28 by Yonghui Huang
 */
 
#ifndef ABSTRACTEOS_CAPPRESFORMULAR_H 
#define ABSTRACTEOS_CAPPRESFORMULAR_H 

#include "ChemLib/chemconst.h"

class AbstractEOS_CapPresFormular {
public:
	/**
	  * constructor, input is the number of unknowns
	  */
	AbstractEOS_CapPresFormular(std::size_t n_unknowns)
		:N(n_unknowns)
	{};
	...
	/**
	  ...
	  */
	virtual ~AbstractEOS_CapPresFormular() {};
