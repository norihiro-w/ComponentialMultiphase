...
*
*
* \file Fem_CMP_GlobalComplementary_Solution.h
*
* Created on 2015-04-20 by Yonghui HUANG
*/

#ifndef FEM_CMP_GlobalComplementary_SOLUTION_H
#define FEM_CMP_GlobalComplementary_SOLUTION_H
...
namespace SolutionLib
{
	...
	*/
	...
	class Fem_CMP_GlobalComplementary_Solution : public TimeSteppingProblem
	{
	public:
		...
		/**
		  * constructor
		  */
		explicit Fem_CMP_GlobalComplementary_Solution(MyDiscreteSystem* dis)
		...
		/**
		  * destructor
		  */
		virtual ~Fem_CMP_GlobalComplementary_Solution()
		{
	...
	private:
		DISALLOW_COPY_AND_ASSIGN(Fem_CMP_GlobalComplementary_Solution);
